  ...
  return (
    <div className=" font-euclidRegular">
      <div className="text-center ">
        <p className="px-3 text-4xl text-center text-gray-900 font-euclidBold dark:text-gray-300 lg:text-5xl">
          Discover Our
          <span className="px-2 text-4xl dark:text-orange-200 text-emerald-300 lg:text-5xl ">
            Luxury
          </span>{" "}
          Hotel Collection
        </p>
      ...
      <div className="max-w-[1400px] h-[650px] w-full mx-auto pb-16 px-4 relative group my-4">
        ...
        {/* Left Arrow */}
        <div className="hidden group-hover:block absolute top-[47%] -translate-x-0 translate-y-[-50%] left-5 text-2xl rounded-full ml-4 p-1  text-white cursor-pointer">
          <img src={left} className="w-10 h-10 " onClick={prevSlide} alt="" />
        </div>
        {/* Right Arrow */}
        <div className="hidden group-hover:block absolute top-[47%] -translate-x-0 translate-y-[-50%] right-5 text-2xl rounded-full mr-4 p-1   text-white cursor-pointer">
        ...
        <div className="flex justify-center py-2 top-4">
          {slides.map((slide, slideIndex) => (
            <div
              ...
              <div className="w-3 h-3 mx-3 bg-gray-900 rounded-full dark:bg-emerald-200 "></div>
            </div>
          ))}
        </div>
      </div>
