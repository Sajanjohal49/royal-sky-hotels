      ...
      <section class="bg-gray-50 dark:bg-gray-900  bg-login ">
        <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
          <div className="flex justify-center text-center">
            ...
            <a
              href="/"
              class="flex pl-2 items-center mb-6 text-3xl font-extrabold text-gray-100 dark:text-white">
            ...
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <form class="space-y-4 md:space-y-6" action="#">
                ...
                <div class="flex items-center justify-between">
                  ...
                  <a
                    href="#"
                    class="text-sm font-medium text-emerald-600 hover:underline dark:text-primary-500">
                    Forgot password?
                  </a>
                </div>
                <button
                ...
                <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                  ...
                  <a
                    href="#"
                    class="font-medium text-emerald-600 -600 hover:underline dark:text-primary-500">
                    Sign up
                  </a>
                </p>
              </form>
