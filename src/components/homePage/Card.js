...
function Card({ cardImage, name, location, price }) {
  return (
    <div className="py-4 mx-auto sm:mx-0">
      <div className="w-full max-w-sm pb-6 bg-white border border-gray-200 rounded-xl dark:bg-transparent dark:border-gray-700">
        <div className="">
          {" "}
          <a href="#">
            <img
