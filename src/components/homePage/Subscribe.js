...
const Subscribe = () => {
  return (
    <div>
      <section class="flex z-50 absolute top-0  w-full">
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 ">
          <div class="mx-auto max-w-screen-md sm:text-center">
            ...
            <form action="# ">
              ...
              <div class="mx-auto max-w-screen-sm text-xs text-left text-gray-200  newsletter-form-footer dark:text-gray-200 ">
